...
class MigrationGenerator extends BaseGenerator
{
    ...
    public function __construct($commandData)
    {
        ...
        $this->path = config('pwweb.artomator.path.migration', database_path('migrations/'));
    }

    public function generate()
    {
        $templateData = get_template('migration', 'artomator');
    ...
    private function generateFields()
    {
        ...
        return implode(arty_nl_tab(1, 3), array_merge($fields, $foreignKeys));
    }
